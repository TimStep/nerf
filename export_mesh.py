...
#Weights are downloaded by running download_example_weights.sh
...
#Query network on dense 3d grid of points (do i need it?)
...
### Uncomment to save out the mesh (uncommented)
mcubes.export_mesh(vertices, triangles, "logs/lego_example/lego_{}.dae".format(N), "lego")


#Uncomment to preview with trimesh (probably will be used in qt)
...
#save video with pyrender (deleted because useless)
